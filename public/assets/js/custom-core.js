    ...
    AIZ.uploader = {
        ...
        getAllUploads: function(url, search_key = null, sort_key = null) {
            ...
            $.get(url, params, function(data, status) {
                ...
                AIZ.uploader.addHiddenValue();
                //AIZ.uploader.resetFilter();
                console.log('aaaaa' + JSON.stringify(AIZ.uploader.data.allFiles_v2));
                console.log('bbbbb' + JSON.stringify(AIZ.uploader.data.allFiles));
                AIZ.uploader.updateUploaderFiles();
        ...
        updateUploaderFiles: function() {
            ...
            // console.log(AIZ.uploader.data.allFiles)
            var data = AIZ.uploader.data.allFiles_v2;
            ...
            $.post(
                ...
                function(data) {
                    ...
                    $('[data-toggle="aizUploaderAddSelected"]').on(
                        "click",
                        function() {
                            const files = AIZ.uploader.data.selectedFiles;
                            if (files.length > 10) {
